OC.L10N.register(
    ...
    "\"%1$s\" (%2$s) registered a new account on %3$s." : "\"%1$s\" (%2$s) registrou uma nova conta em %3$s.",
    ...
    "User registration\n\nThis app allows users to register a new account.\n\n# Features\n\n- Add users to a given group\n- Allow-list with email domains (including wildcard) to register with\n- Administrator will be notified via email for new user creation or require approval\n- Supports Nextcloud's Client Login Flow v1 and v2 - allowing registration in the mobile Apps and Desktop clients\n\n# Web form registration flow\n\n1. User enters their email address\n2. Verification link is sent to the email address\n3. User clicks on the verification link\n4. User is lead to a form where they can choose their username and password\n5. New account is created and is logged in automatically" : "Registro do usuário\n\nEste aplicativo permite que os usuários registrem uma nova conta.\n\n# Recursos\n\n- Adicionar usuários a um determinado grupo\n- Lista de permissões com domínios de e-mail (incluindo curinga) para se registrar\n- O administrador será notificado por e-mail para criação de novo usuário ou requer aprovação\n- Suporta o fluxo de login do cliente Nextcloud v1 e v2 - permitindo o registro nos aplicativos móveis e clientes de desktop\n\n# Fluxo de registro de formulário web\n\n1. O usuário insere seu endereço de e-mail\n2. O link de verificação é enviado para o endereço de e-mail\n3. O usuário clica no link de verificação\n4. O usuário é direcionado a um formulário onde pode escolher seu nome de usuário e senha\n5. Nova conta é criada e conectada automaticamente",
    "Registration settings" : "Ajustes de cadastro",
    "Require administrator approval" : "Exigir aprovação do administrador",
    ...
    "Disable email verification" : "Desabilitar verificação de e-mail",
