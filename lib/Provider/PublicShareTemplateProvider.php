...
namespace OCA\MyCompany\Provider;
...
class PublicShareTemplateProvider implements IPublicShareTemplateProvider {
	...
	public function renderPage(IShare $share, string $token, string $path): TemplateResponse {
		...
		Util::addStyle('my_company', 'publicView');
		...
		$response = new TemplateResponse(Application::APP_ID, 'public', $shareTmpl, TemplateResponse::RENDER_AS_BASE);
